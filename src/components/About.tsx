      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-start">
          <motion.div
            ...
            className="space-y-5"
          >
            <motion.p variants={v(staggerItem)} className="text-muted-foreground text-base md:text-lg leading-relaxed">
            ...
            <motion.p variants={v(staggerItem)} className="text-muted-foreground leading-relaxed text-sm md:text-base">
          ...
          >
            {highlights.map((item) => (
              <motion.div
                ...
                className="p-4 md:p-5 premium-card glow-card group"
              >
